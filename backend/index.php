<?php
header("Access-Control-Allow-Origin: https://thecap.thatrichard.space"); // http://localhost:5173 | https://thecap.thatrichard.space
				...
				if (isset($path[1])) {
					if (is_numeric($path[1])) {
						...
						$article_item = array(
							...
							"perex" => $article->perex,
							"urlSlug" => $article->urlSlug,
							"authorUrlSlug" => $article->authorUrlSlug
						);
						echo json_encode($article_item);
					}
				} else {
